...
void DrawMenu() {
    ...
    if (ShowMenu)
    {
        ...
        ImGui::SetWindowSize(ImVec2(850, 550));

        ImGui::SetCursorPos(ImVec2(10, 10));
        ImGui::TextColored(ImColor(255,182,193), xorstr_("RebelWare | DAYZ"));
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[3]);
        ImGui::TextColored(ImColor(100, 100, 100), xorstr_("- Days Left | Last Updated May 21"));
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[1]);

        ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 120, MainWindowPos.y + 50));
        style->ItemSpacing = ImVec2(3, 5);
        ImGui::BeginChild(xorstr_("##BackGroundWindow"), ImVec2(720, 490), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
        {
            style->ChildRounding = 4.0f;
            style->Colors[ImGuiCol_ChildBg] = ImColor(20, 20, 20);

            if (tabb == 1) {
                ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130, MainWindowPos.y + 60));
                ImGui::BeginChild(xorstr_("##CheatSection1Aimbot"), ImVec2(340.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Global"));
                    ImGui::Checkbox(xorstr_("Enable"), &config::Aimbot::MasterSwitch);
                    ImGui::Checkbox(xorstr_("Hit Players"), &config::Aimbot::HitPlayers);
                    ImGui::Checkbox(xorstr_("Hit Zombies"), &config::Aimbot::HitZombies);
                    ImGui::Checkbox(xorstr_("Enable AimKey"), &config::Aimbot::AimbotKey);
                    ImGui::Combo(xorstr_("Aimbot Key"), &config::Aimbot::selectedKey, config::Aimbot::keys, IM_ARRAYSIZE(config::Aimbot::keys));
                }
                ImGui::EndChild();

                ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130 * 4 - 40, MainWindowPos.y + 60));
                ImGui::BeginChild(xorstr_("##CheatSection2Aimbot"), ImVec2(346.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Silent Aim"));
                    ImGui::Checkbox(xorstr_("Enable Silent-Aim"), &config::Aimbot::SilentAim);
                    ImGui::Checkbox(xorstr_("Show Fov"), &config::Aimbot::ShowFov);
                    ImGui::SliderFloat(xorstr_("FOV Size##93822"), &config::Aimbot::Fov, 1, 100, "%.3f");
                    ImGui::SameLine();
                    ImGui::ColorEdit4(xorstr_("927222"), config::Aimbot::FovCircleColor, true | 128 | 256 | 32 | 512 | 256);
                    ImGui::SliderFloat(xorstr_("Max Distance##18211"), &config::Aimbot::MaxDistance, 50, 300, "%.3f");
                }
                ImGui::EndChild();
            }
            ...
            if (tabb == 2) {
                ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130, MainWindowPos.y + 60));
                ImGui::BeginChild(xorstr_("##CheatSection1ESP"), ImVec2(236.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Global"));
                    ImGui::Checkbox(xorstr_("Enable Visuals"), &config::Visuals::Global);
                }
                ImGui::EndChild();

                ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130 * 3 - 15, MainWindowPos.y + 60));
                ImGui::BeginChild(xorstr_("##CheatSection2ESP"), ImVec2(236.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Players"));
                    ImGui::Checkbox(xorstr_("Enable Players##Player"), &config::Visuals::Player::MasterSwitch);
                    ImGui::Checkbox(xorstr_("Show Name##Player"), &config::Visuals::Player::ShowName);
                    ImGui::SameLine();
                    ImGui::ColorEdit4("3729822", config::Visuals::Player::NameColor, true | 128 | 256 | 32 | 512 | 256);
                    ImGui::Checkbox(xorstr_("Show Item Holding##Player"), &config::Visuals::Player::ShowItemHolding);
                    ImGui::SameLine();
                    ImGui::ColorEdit4("81738322", config::Visuals::Player::ItemColor, true | 128 | 256 | 32 | 512 | 256);
                    ImGui::SliderFloat("Max Distance##Player", &config::Visuals::Player::MaxDistance, 50, 1000, "%.3f");

                    ImGui::SeparatorText(xorstr_("Infected"));
                    ImGui::Checkbox(xorstr_("Enable Infected##Infected"), &config::Visuals::Zombie::MasterSwitch);
                    ImGui::Checkbox(xorstr_("Show Name##Infected"), &config::Visuals::Zombie::ShowName);
                    ImGui::SameLine();
                    ImGui::ColorEdit4(xorstr_("23822"), config::Visuals::Zombie::NameColor, true | 128 | 256 | 32 | 512 | 256);
                    ImGui::SliderFloat(xorstr_("Max Distance##Infected"), &config::Visuals::Zombie::MaxDistance, 50, 1000, "%.3f");

                    ImGui::SeparatorText(xorstr_("Animals"));
                    ImGui::Checkbox(xorstr_("Enable Animals##Animals"), &config::Visuals::Animal::MasterSwitch);
                    ImGui::Checkbox(xorstr_("Show Name##Animals"), &config::Visuals::Animal::ShowName);
                    ImGui::SameLine();
                    ImGui::ColorEdit4(xorstr_("342817"), config::Visuals::Animal::NameColor, true | 128 | 256 | 32 | 512 | 256);
                    ImGui::SliderFloat(xorstr_("Max Distance##Animals"), &config::Visuals::Animal::MaxDistance, 50, 1000, "%.3f");
                }
                ImGui::EndChild();

                ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130 * 5 - 30, MainWindowPos.y + 60));
                ImGui::BeginChild(xorstr_("##CheatSection3ESP"), ImVec2(210.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Items"));
                    ImGui::Checkbox(xorstr_("Show Items"), &config::Visuals::Items::MasterSwitch);
                    ImGui::Checkbox(xorstr_("Show Weapons"), &config::Visuals::Items::ShowWeapons);
                    ImGui::SameLine();
                    ImGui::ColorEdit4(xorstr_("23191"), config::Visuals::Items::WeaponColor, true | 128 | 256 | 32 | 512 | 256);

                    ImGui::Checkbox(xorstr_("Show Clothing"), &config::Visuals::Items::ShowClothing);
                    ImGui::SameLine();
                    ImGui::ColorEdit4(xorstr_("65475"), config::Visuals::Items::ClothingColor, true | 128 | 256 | 32 | 512 | 256);

                    ImGui::Checkbox(xorstr_("Show Misc"), &config::Visuals::Items::ShowMisc);
                    ImGui::SameLine();
                    ImGui::ColorEdit4(xorstr_("57655"), config::Visuals::Items::MiscColor, true | 128 | 256 | 32 | 512 | 256);
                    ImGui::SliderFloat(xorstr_("Max Distance##Items"), &config::Visuals::Items::MaxDistance, 50, 1000, "%.3f");
            ...
            if (tabb == 3) {
                ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130, MainWindowPos.y + 60));
                ImGui::BeginChild(xorstr_("##CheatSection1Game"), ImVec2(340.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Under Construction..."));
                }
                ImGui::EndChild();

                ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130 * 4 - 40, MainWindowPos.y + 60));
                ImGui::BeginChild(xorstr_("##CheatSection2Game"), ImVec2(346.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Under Construction..."));
                }
                ImGui::EndChild();
            ...
            if (tabb == 4) {
                ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130, MainWindowPos.y + 60));
                ImGui::BeginChild(xorstr_("##CheatSection1Misc"), ImVec2(340.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Under Construction..."));
                }
                ImGui::EndChild();
                ...
                ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130 * 4 - 40, MainWindowPos.y + 60));
                ImGui::BeginChild(xorstr_("##CheatSection2Misc"), ImVec2(346.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Under Construction..."));
                }
                ImGui::EndChild();
            ...
            if (tabb == 5) {
                ...
                ImGui::BeginChild(xorstr_("##CheatSection1Players"), ImVec2(687.32, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Under Construction..."));
                }
                ImGui::EndChild();
                ...
                //ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130 * 4 - 40, MainWindowPos.y + 60));
                //ImGui::BeginChild("##CheatSection2Players", ImVec2(346.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                //{
                //    ImGui::SeparatorText("Enemy Team");
                //}
                //ImGui::EndChild();
            }
            ...
            if (tabb == 6) {
                ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130, MainWindowPos.y + 60));
                ImGui::BeginChild(xorstr_("##CheatSection1Config"), ImVec2(340.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Config Options"));

                    style->Colors[ImGuiCol_Button] = ImColor(40, 40, 40);
                    style->Colors[ImGuiCol_ButtonHovered] = ImColor(30, 30, 30);
                    style->Colors[ImGuiCol_ButtonActive] = ImColor(25, 25, 25);
                ...
                ImGui::SetNextWindowPos(ImVec2(MainWindowPos.x + 130 * 4 - 40, MainWindowPos.y + 60));
                ImGui::BeginChild(xorstr_("##CheatSection2Config"), ImVec2(346.66, 470), true, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoScrollbar);
                {
                    ImGui::SeparatorText(xorstr_("Under Construction..."));
                }
                ImGui::EndChild();
        ...
        style->ItemSpacing = ImVec2(5, 15);
        if (tabb == 1)
            style->Colors[ImGuiCol_Text] = ImColor(255,182,193);
        else
            style->Colors[ImGuiCol_Text] = ImColor(100, 100, 100);

        ImGui::SetCursorPos(ImVec2(10, 65));
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[2]);
        ImGui::Text(xorstr_("A"));
        ImGui::SameLine();
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[1]);
        ...
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[2]);
        ImGui::Text(xorstr_("D"));
        ImGui::SameLine();
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[1]);
        if (ImGui::Button(xorstr_("Visuals")))
            tabb = 2;
        ...
        // ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[2]);
        // ImGui::Text(xorstr_("C"));
        // ImGui::SameLine();
        // ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[1]);
        // if (ImGui::Button(xorstr_("Game")))
        //     tabb = 3;
        ...
        // ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[2]);
        // ImGui::Text(xorstr_("K"));
        // ImGui::SameLine();
        // ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[1]);
        // if (ImGui::Button(xorstr_("Players")))
        //     tabb = 5;
        ...
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[2]);
        ImGui::Text(xorstr_("J"));
        ImGui::SameLine();
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[1]);
        if (ImGui::Button(xorstr_("Config")))
            tabb = 6;
